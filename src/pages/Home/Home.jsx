      ...
      <div className="bg-gray-100 pt-40 pb-12" id="home">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
            ...
            {/* <div className="col-span-1 lg:col-span-3 flex flex-col gap-6 sm:gap-8">
              <div className="group flex-1">
                <Link to="/categories/kitchen" className="block h-full">
                  <div className="relative h-48 lg:h-[calc(50vh-9rem)] overflow-hidden rounded-2xl shadow-lg transition-all duration-300 ease-in-out group-hover:shadow-xl">
                    <img
                      src={kitchen}
                      alt="Kitchen"
                      className="w-full h-full object-cover transition-all duration-500 ease-in-out group-hover:scale-105 group-hover:brightness-75"
